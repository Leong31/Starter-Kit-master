...
void save(Character::Alien &aliens, Character::Zombie &zombies, int &column, int &row, string **arr, int **PositionZombie, int x, int y, string saveFileName)
{
    // Alien.
    ofstream file;
...
int getSavedAlienPositionX(string loadFileName)
{
...
int getSavedAlienPositionY(string loadFileName)
{
...
string **getSavedArray(string filename)
{
    int row, col;
    string line;
    string **newArray;
...
int **getSavedPositionZombie(string filename)
{
    int row, col;
    string line;
    int **newArray;
    ...
    if (portal == false)
    {
        ...
        for (int i = 0; i < 2; ++i)
        {
            do
            {
                randomRow = rand() % row;
                randomColumn = rand() % column;
            } while (arr[randomRow][randomColumn] == "A" || arr[randomRow][randomColumn] == "1" || arr[randomRow][randomColumn] == "2" || arr[randomRow][randomColumn] == "3" || arr[randomRow][randomColumn] == "4" || arr[randomRow][randomColumn] == "5" || arr[randomRow][randomColumn] == "6" || arr[randomRow][randomColumn] == "7" || arr[randomRow][randomColumn] == "8" || arr[randomRow][randomColumn] == "9" || arr[randomRow][randomColumn] == "@");
